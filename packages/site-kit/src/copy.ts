...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    calcNote:
      "Layout only — not live fund data. Mutual fund investments are subject to market risks.",
    send: "Send",
    name: "Name",
    mobile: "Mobile",
    city: "City",
    ...
    toolPlaceholder: "This tool will use Advisorkhoj APIs. Layout only for now.",
    backHome: "Home",
  ...
  hi: {
    ...
    calcNote: "केवल लेआउट — लाइव फंड डेटा नहीं। म्यूचुअल फंड निवेश बाजार जोखिमों के अधीन हैं।",
    send: "भेजें",
    name: "नाम",
    mobile: "मोबाइल",
    city: "शहर",
    ...
    toolPlaceholder: "यह टूल Advisorkhoj API से जुड़ेगा। अभी केवल लेआउट है।",
    backHome: "होम",
